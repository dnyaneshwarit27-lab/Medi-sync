    ...
    <div class="max-w-md w-full bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl p-10 relative overflow-hidden transition-colors border border-transparent dark:border-slate-800">
        <div class="relative z-10">
            <div class="mb-10 text-center">
                ...
                <h2 class="text-3xl font-bold text-slate-900 dark:text-white">Create New Password</h2>
                <p class="text-slate-500 dark:text-slate-400 mt-2 font-medium">Enter the OTP sent to <?php echo htmlspecialchars($_SESSION['reset_email']); ?></p>
            </div>
            ...
            <form method="POST" class="space-y-6">
                <div>
                    <label class="block text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-3">6-Digit Verification OTP</label>
                ...
                <div>
                    <label class="block text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-3">New Password</label>
                ...
                <div>
                    <label class="block text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-3">Confirm New Password</label>
